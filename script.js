    ...
    const teamColors = {
        ...
        "Neutral": { dotColor: '#ffff00', boxBg: 'rgba(255, 255, 0, 0.2)', boxShadow: '0 0 8px #ffff00' }, /* Yellow */
...
`;
    ...
    const allEntitiesData = [
        ...
        { category: "Role", name: "Sheriff", team: "Crewmate", desc: "The Sheriff is a crewmate who can kill, their job is to kill the Impostors, however, if they attempt to kill a crewmate, they will die themselves.", ability: "Kill", icon: 'Sheriff', skillIcon: 'TownOfUs.Resources.CrewButtons.SheriffShootButton.png', types: ["Kill"] },
        { category: "Role", name: "Veteran", team: "Crewmate", desc: "The Veteran is a crewmate who has the option to go on alert. When they are on alert they will kill whoever interacts with them, this includes, tracking, shielding, seering, dousing, hacking and even killing!", ability: "Toggle Alert", icon: 'Veteran', skillIcon: 'TownOfUs.Resources.CrewButtons.AlertButton.png', types: ["Kill", "Support"] },
        { category: "Role", name: "Vigilante", team: "Crewmate", desc: "The Vigilante is a crewmate who has the option during a meeting to guess someone else's role, if they are correct the other person dies, if the Vigilante is incorrect, the Vigilante dies.", ability: "Guess Role", icon: 'Vigilante', skillIcon: 'TownOfUs.Resources.GameSummeryButton.Guess.png', types: ["Kill"] },
        { category: "Role", name: "Altruist", team: "Crewmate", desc: "The Altruist is a crewmate who can revive other players. To do this they must be located near a body. When they start reviving all Neutral Killers and Impostors get an alert that an Altruist is reviving and an arrow pointing towards the Altruist. After the revive duration ends, killers instead get an arrow to all revived players. The Altruist and revived players cannot button once a revive has taken place.", ability: "Revive", icon: 'Altruist', skillIcon: 'TownOfUs.Resources.CrewButtons.ReviveButton.png', types: ["Support"] },
        { category: "Role", name: "Cleric", team: "Crewmate", desc: "The Cleric is a crewmate who can barrier other players, providing temporary defence and cleanse other players, removing all negative effects (e.g. blackmail, douse).", ability: "Barrier / Cleanse", icon: 'Cleric', skillIcon: 'TownOfUs.Resources.CrewButtons.CleanseButton.png', types: ["Support"] },
        ...
        { category: "Role", name: "Oracle", team: "Crewmate", desc: "During rounds the Oracle can choose to make someone confess on their demise (death). The alliance of that player is revealed to a certain accuracy to everyone in the meeting after the Oracle’s death. In addition to that, the Oracle will receive a confession from that player at the start of each meeting, they will receive information that either that confessing player, or 2 others is evil. They also have another ability, bless, that provides someone immunity during meetings!", ability: "Confess / Bless", icon: 'Oracle', skillIcon: 'TownOfUs.Resources.CrewButtons.ConfessButton.png', types: ["Detection", "Support"] },
        { category: "Role", name: "Warden", team: "Crewmate", desc: "The Warden is a crewmate who can Fortify a player, if anyone interacts with this fortified player the ability will fail and both the Warden and person attempting to use an ability will get a purple flash on their screen.", ability: "Fortify Player", icon: 'Warden', skillIcon: 'TownOfUs.Resources.CrewButtons.FortifyButton.png', types: ["Support"] },
        { category: "Role", name: "Engineer", team: "Crewmate", desc: "The Engineer is a crewmate who can both vent and fix sabotages.", ability: "Vent / Fix Sabotage", icon: 'Engineer', skillIcon: 'TownOfUs.Resources.CrewButtons.EngiButton.png', types: ["Utility"] },
        { category: "Role", name: "Imitator", team: "Crewmate", desc: "The Imitator is a crewmate who can use fallen crewmates to their advantage. During meetings the Imitator can select a player who they wish to imitate the following round. They will not know what role they are imitating until the following round.", ability: "Imitate Role", icon: 'Imitator', skillIcon: 'TownOfUs.Resources.ImitatorSelect.png', types: ["Utility", "Other"] },
        { category: "Role", name: "Mayor", team: "Crewmate", desc: "Once per game the Mayor can reveal themselves as the Mayor mid-meeting, once done so they gain an additional 2 votes.", ability: "Reveal as Mayor", icon: 'Mayor', skillIcon: 'TownOfUs.Resources.MayorButton.png', types: ["Utility"] },
        { category: "Role", name: "Medium", team: "Crewmate", desc: "The Medium is a crewmate who can see ghosts. During rounds the Medium has an option to Mediate, which lets ghosts know who the Medium is, as well as where they are, and the same thing for the Medium in reverse.", ability: "Mediate", icon: 'Medium', skillIcon: 'TownOfUs.Resources.CrewButtons.MediateButton.png', types: ["Utility", "Detection"] },
        { category: "Role", name: "Plumber", team: "Crewmate", desc: "The Plumber is a crewmate who can flush vents, ejecting all players in vents at that moment and barricade vents, placing a barricade on that vent the following round.", ability: "Flush / Barricade", icon: 'Plumber', skillIcon: 'TownOfUs.Resources.CrewButtons.FlushButton.png', types: ["Utility", "Sabotage"] },
        ...
        { category: "Role", name: "Prosecutor", team: "Crewmate", desc: "The Prosecutor has 2 abilities, one is the ability for them to see all the votes (non-anonymous voting), the other, once per game during a meeting the Prosecutor can prosecute someone, making all other votes redundant and having whoever the Prosecutor selected exiled that meeting.", ability: "Prosecute", icon: 'Prosecutor', skillIcon: 'TownOfUs.Resources.RoleIcons.Prosecutor.png', types: ["Utility", "Detection"] }, // This one is a bit unique with a full role icon filename as skill icon
        { category: "Role", name: "Swapper", team: "Crewmate", desc: "The Swapper is a crewmate who can swap two players during a meeting.", ability: "Swap Players", icon: 'Swapper', skillIcon: 'Swap.png', types: ["Utility"] },
        ...
        // Neutral Roles
        { category: "Role", name: "Amnesiac", team: "Neutral", desc: "The Amnesiac is a neutral role which can remember the role of a dead player. Their objective is to find a dead body in order to remember who they were. This means they can remember that they were an Impostor!", ability: "Remember Role", icon: 'Amnesiac', skillIcon: 'TownOfUs.Resources.NeutButtons.RememberButton.png', types: ["Other"] },
        { category: "Role", name: "Guardian Angel", team: "Neutral", desc: "The Guardian Angel is a neutral role which has one job, to protect their target and make sure they live. If their target wins they win.", ability: "Protect Target", icon: 'GuardianAngel', skillIcon: 'TownOfUs.Resources.NeutButtons.ProtectButton.png', types: ["Support"] },
        { category: "Role", name: "Mercenary", team: "Neutral", desc: "The Mercenary is a neutral role which can guard other players, allowing them to absorb abilities on other players. And bribe, using gold (from converting absorbed abilities) to bribe other players to join their team. If any bribed player lives and wins, the Mercenary does too.", ability: "Guard / Bribe", icon: 'Mercenary', skillIcon: 'TownOfUs.Resources.NeutButtons.BribeButton.png', types: ["Support"] },
        { category: "Role", name: "Survivor", team: "Neutral", desc: "The Survivor is a neutral role which has to live to win, however, if any neutral evil role or lovers win the Survivor still loses.", ability: "No Active Ability", icon: 'Survivor', skillIcon: 'Passive.png', types: ["Other"] }, // Passive doesn't have a specific ability icon
        ...
        { category: "Role", name: "Executioner", team: "Neutral", desc: "The Executioner is a neutral role who needs to vote out a certain crewmate to win.", ability: "No Active Ability", icon: 'Executioner', skillIcon: 'Passive.png', types: ["Other"] }, // Passive doesn't have a specific ability icon
        { category: "Role", name: "Jester", team: "Neutral", desc: "The Jester is a neutral role who needs to be voted out to win.", ability: "No Active Ability", icon: 'Jester', skillIcon: 'Passive.png', types: ["Other"] }, // Passive doesn't have a specific ability icon
        { category: "Role", name: "Phantom", team: "Neutral", desc: "Once a random crewmate dies they become the Phantom. To win the Phantom needs to complete all their tasks, however, to stop them any player can click them which kills them.", ability: "Passive Ability", icon: 'Phantom', skillIcon: 'Ghost.png', types: ["Other"] }, // Ghost icon shared
        { category: "Role", name: "Soul Collector", team: "Neutral", desc: "The Soul Collector wins by collecting a certain number of souls. Each round the Soul Collector may Reap players and Collect souls. For a soul to spawn a player must first be reaped and then they must die. Everyone sees a soul on the ground for the remaining duration of the round since a soul spawns. The Soul Collector sees the soul until they collect it.", ability: "Reap / Collect Souls", icon: 'SoulCollector', skillIcon: 'TownOfUs.Resources.NeutButtons.ReapButton.png', types: ["Kill", "Other"] },
        { category: "Role", name: "Arsonist", team: "Neutral", desc: "The Arsonist is a neutral role who needs to kill everyone to win. The Arsonist however, does not have a kill button. Instead they need to douse and ignite people. The Arsonist is unique in that they can kill multiple people at once with one ignite, when they ignite all douses nearby die.", ability: "Douse / Ignite", icon: 'Arsonist', skillIcon: 'TownOfUs.Resources.NeutButtons.DouseButton.png', types: ["Kill", "Sabotage"] },
        { category: "Role", name: "Juggernaut", team: "Neutral", desc: "The Juggernaut is a neutral role who needs to kill everyone to win. The Juggernaut's special querk is that they have an altered kill cooldown which decreases with each kill. The starting kill cooldown is the Glitch kill cooldown plus 5 seconds.", ability: "Kill", icon: 'Juggernaut', skillIcon: 'TownOfUs.Resources.NeutButtons.JuggKillButton.png', types: ["Kill"] },
        { category: "Role", name: "Plaguebearer", team: "Neutral", desc: "The Plaguebearer is a neutral role who needs to infect everyone to turn into Pestilence (not win the game). The infection can be spread by other players via seering, tracking, examining, killing etc.", ability: "Infect", icon: 'Plaguebearer', skillIcon: 'TownOfUs.Resources.NeutButtons.InfectButton.png', types: ["Kill", "Sabotage"] },
        { category: "Role", name: "Pestilence", team: "Neutral", desc: "The Pestilence is a neutral role who needs to kill everyone to win, however the only way to get rid of Pestilence is by voting it out in a meeting, otherwise it is unkillable.", ability: "Passive Ability", icon: 'Pestilence', skillIcon: 'Passive.png', types: ["Kill", "Sabotage", "Other"] }, // Passive doesn't have a specific ability icon
        { category: "Role", name: "Glitch", team: "Neutral", desc: "The Glitch is a neutral role who needs to kill everyone to win. The glitch also has additional abilities including hacking, which disables all abilities of the hacked player, and mimicing which makes them transform into another player.", ability: "Glitch / Mimic", icon: 'Glitch', skillIcon: 'TownOfUs.Resources.NeutButtons.HackButton.png', types: ["Kill", "Sabotage"] },
        { category: "Role", name: "Vampire", team: "Neutral", desc: "The Vampire and Vampire Faction wins by being the only players alive. During the game Vampires can bite other players. Every player a Vampire bites dies, except the first Crewmate, in this case the Crewmate is converted into a Vampire and loses their original ability. The only exception to this is when they bite a Vampire Hunter, in this case the Vampire Hunter stakes the Vampire. Once there are 2 Vampires alive no more players can be converted into Vampires, however, depending on settings if 1 dies they may be able to convert again.", ability: "Bite", icon: 'Vampire', skillIcon: 'TownOfUs.Resources.NeutButtons.BiteButton.png', types: ["Kill"] },
        { category: "Role", name: "Werewolf", team: "Neutral", desc: "The Werewolf is a neutral role who needs to kill everyone to win. The Werewolf cannot kill unless they are rampaged. Once they are rampaged the Werewolf can kill multiple people during a short duration.", ability: "Transform / Rampage", icon: 'Werewolf', skillIcon: 'TownOfUs.Resources.NeutButtons.RampageButton.png', types: ["Kill"] },

        // Impostor Roles
        { category: "Role", name: "Eclipsal", team: "Impostor", desc: "The Eclipsal is an Impostor who can blind other players for a moderate amount of time. Blinded players have Ox vision and their report button doesn't light up.", ability: "Blind", icon: 'Eclipsal', skillIcon: 'TownOfUs.Resources.ImpButtons.BlindButton.png', types: ["Sabotage"] },
        { category: "Role", name: "Escapist", team: "Impostor", desc: "The Escapist is an Impostor who can teleport to a desired location on the map whenever they feel like (on cooldown).", ability: "Teleport", icon: 'Escapist', skillIcon: 'TownOfUs.Resources.ImpButtons.RecallButton.png', types: ["Utility"] },
        { category: "Role", name: "Grenadier", team: "Impostor", desc: "The Grenadier is an Impostor who can throw down a flash grenade. When this is done all players inside a small radius get blinded by the flash grenade.", ability: "Throw Grenade", icon: 'Grenadier', skillIcon: 'TownOfUs.Resources.ImpButtons.FlashButton.png', types: ["Kill"] },
        ...
        { category: "Role", name: "Swooper", team: "Impostor", desc: "The Swooper is an Impostor who can turn invisible for a short period of time.", ability: "Turn Invisible", icon: 'Swooper', skillIcon: 'TownOfUs.Resources.ImpButtons.SwoopButton.png', types: ["Utility"] },
        { category: "Role", name: "Venerer", team: "Impostor", desc: "The Venerer is an Impostor who gains perks for killing. The perks in order are: a camouflage ability (for just the Venerer), a sprint ability and finally a freeze ability which temporarily slows all players except the Venerer.", ability: "Passive Ability", icon: 'Venerer', skillIcon: 'Passive.png', types: ["Sabotage", "Utility"] }, // Passive doesn't have a specific ability icon
        { category: "Role", name: "Bomber", team: "Impostor", desc: "The Bomber is an Impostor who can plant bombs around the map. When a bomb is planted it will detonate x seconds later (according to settings). Once detonated the bomb will kill anyone in the radius of the blast, including themselves or teammates.", ability: "Plant Bomb", icon: 'Bomber', skillIcon: 'TownOfUs.Resources.ImpButtons.DetonatingButton.png', types: ["Kill", "Sabotage"] },
        { category: "Role", name: "Scavenger", team: "Impostor", desc: "The Scavenger is an Impostor who must hunt down prey. When their kill cooldown becomes available they are given a timer and a target, if they kill the target the timer increases and they get a new target, if they kill wrong they get a significantly increased kill cooldown and if they don't kill anyone their kill cooldown resets.", ability: "Scavenge / Hunt", icon: 'Scavenger', skillIcon: 'TownOfUs.Resources.ImpButtons.ScavengeButton.png', types: ["Utility", "Sabotage"] },
        { category: "Role", name: "Traitor", team: "Impostor", desc: "Once all Impostors die, a random crewmate becomes the Traitor, the Traitor can select an Impostor role to be and their sole purpose is to avenge all fallen Impostors.", ability: "No Active Ability", icon: 'Traitor', skillIcon: 'Passive.png', types: ["Other"] }, // Passive doesn't have a specific ability icon
        { category: "Role", name: "Warlock", team: "Impostor", desc: "The Warlock is an Impostor who can charge up their kill button by not killing for a long duration. Once the Warlock hits kill their charge starts decreasing and the Warlock can keep killing until this charge runs out.", ability: "Charge Kill", icon: 'Warlock', skillIcon: 'Charge.png', types: ["Sabotage"] },
        { category: "Role", name: "Blackmailer", team: "Impostor", desc: "The Blackmailer is an Impostor who can silence a player in a meeting. During each round the Blackmailer can go up to someone to blackmail them. This prevents the blackmailed player from being able to talk in meetings.", ability: "Blackmail", icon: 'Blackmailer', skillIcon: 'TownOfUs.Resources.ImpButtons.BlackmailButton.png', types: ["Sabotage"] },
        { category: "Role", name: "Hypnotist", team: "Impostor", desc: "The Hypnotist is an Impostor who can Hypnotise players. During a meeting they may then release Mass Hysteria, once released the Hypnotist can no longer hypnotise other players and all hypnotised players now see everyone else as either themselves, camouflaged or invisible.", ability: "Hypnotize / Mass Hysteria", icon: 'Hypnotist', skillIcon: 'TownOfUs.Resources.ImpButtons.HypnotiseButton.png', types: ["Sabotage"] },
        { category: "Role", name: "Janitor", team: "Impostor", desc: "The Janitor is an Impostor who can choose between killing and cleaning. If they choose to clean a body the body disappears and becomes unreportable.", ability: "Clean Body", icon: 'Janitor', skillIcon: 'TownOfUs.Resources.ImpButtons.CleanButton.png', types: ["Utility"] },
        { category: "Role", name: "Miner", team: "Impostor", desc: "The Miner is an Impostor who can place vents around the map. These vents can be used by anyone who can vent and the vents are all connected to each other via a vent system.", ability: "Place Vent", icon: 'Miner', skillIcon: 'TownOfUs.Resources.ImpButtons.MineButton.png', types: ["Utility"] },
        { category: "Role", name: "Undertaker", team: "Impostor", desc: "The Undertaker is an Impostor who can drag and drop bodies to hide them in certain locations.", ability: "Drag Body", icon: 'Undertaker', skillIcon: 'TownOfUs.Resources.ImpButtons.DragButton.png', types: ["Utility"] },

        // Crewmate Modifiers
        { category: "Modifier", name: "Aftermath", team: "Crewmate Modifier", desc: "Aftermath is a Crewmate Modifier which activates upon death. Once the Aftermath is killed the killer of the Aftermath will be forced to use their ability (will have no effect if ability is in use or the killer has no viable ability).", ability: "Passive Ability", icon: 'Aftermath', skillIcon: 'Passive.png', types: ["Passive", "Death Trigger"] }, // Passive doesn't have a specific ability icon
        { category: "Modifier", name: "Bait", team: "Crewmate Modifier", desc: "Bait is a Crewmate Modifier which activates upon death. Once the Bait is killed the killer of the Bait will be forced to report their body.", ability: "Passive Ability", icon: 'Bait', skillIcon: 'TownOfUs.Resources.ModifierIcons.Bait.png', types: ["Passive", "Death Trigger"] },
        { category: "Modifier", name: "Celebrity", team: "Crewmate Modifier", desc: "Celebrity is a Crewmate Modifier that activates the meeting following the Celebrity's death. It tells everyone how, when and where the Celebrity died.", ability: "Passive Ability", icon: 'Celebrity', skillIcon: 'Passive.png', types: ["Passive", "Death Trigger", "Information"] }, // Passive doesn't have a specific ability icon
        { category: "Modifier", name: "Diseased", team: "Crewmate Modifier", desc: "Diseased is a Crewmate Modifier which activates upon death. Once the Diseased is killed the killer of the Diseased will have an increased kill cooldown before they kill again or a meeting is called.", ability: "Passive Ability", icon: 'Diseased', skillIcon: 'Passive.png', types: ["Passive", "Death Trigger", "Debuff"] }, // Passive doesn't have a specific ability icon
        { category: "Modifier", name: "Frosty", team: "Crewmate Modifier", desc: "Frosty is a Crewmate Modifier which activates upon death. Once the Frosty is killed their killer will be temporarily slowed.", ability: "Passive Ability", icon: 'Frosty', skillIcon: 'Passive.png', types: ["Passive", "Death Trigger", "Debuff"] }, // Passive doesn't have a specific ability icon
        { category: "Modifier", name: "Multitasker", team: "Crewmate Modifier", desc: "Multitasker is a Crewmate Modifier which makes all tasks transparent.", ability: "Passive Ability", icon: 'Multitasker', skillIcon: 'Passive.png', types: ["Passive", "Utility"] }, // Passive doesn't have a specific ability icon
        { category: "Modifier", name: "Taskmaster", team: "Crewmate Modifier", desc: "Taskmaster is a Crewmate Modifier which makes the player automatically complete a random task following each meeting.", ability: "Passive Ability", icon: 'Taskmaster', skillIcon: 'Passive.png', types: ["Passive", "Utility"] }, // Passive doesn't have a specific ability icon
        { category: "Modifier", name: "Torch", team: "Crewmate Modifier", desc: "Torch is a Crewmate Modifier which makes lights ineffective against themselves.", ability: "Passive Ability", icon: 'Torch', skillIcon: 'Passive.png', types: ["Passive", "Utility"] }, // Passive doesn't have a specific ability icon

        // Global Modifiers
        { category: "Modifier", name: "Button Barry", team: "Global Modifier", desc: "Button Barry is a Global Modifier which allows themself to button from anywhere on the map, even if a sabotage is currently active.", ability: "Passive Ability", icon: 'ButtonBarry', skillIcon: 'TownOfUs.Resources.BroadcastButton.png', types: ["Passive", "Utility"] },
        { category: "Modifier", name: "Flash", team: "Global Modifier", desc: "Flash is a Global Modifier which gives the player increased speed.", ability: "Passive Ability", icon: 'Flash', skillIcon: 'Passive.png', types: ["Passive", "Buff"] }, // Passive doesn't have a specific ability icon
        { category: "Modifier", name: "Giant", team: "Global Modifier", desc: "Giant is a Global Modifier which increases the size of a player.", ability: "Passive Ability", icon: 'Giant', skillIcon: 'Passive.png', types: ["Passive", "Buff"] }, // Passive doesn't have a specific ability icon
        { category: "Modifier", name: "Immovable", team: "Global Modifier", desc: "Immovable is a Global Modifier which makes the player unable to be moved by disperse, transport and meetings.", ability: "Passive Ability", icon: 'Immovable', skillIcon: 'Passive.png', types: ["Passive", "Defense"] }, // Passive doesn't have a specific ability icon
        { category: "Modifier", name: "Lovers", team: "Global Modifier", desc: "Lovers is a Global Modifier which links two players who can both chat with each other during rounds and win together in the final 3 if both players are alive.", ability: "Passive Ability", icon: 'Lover', skillIcon: 'Passive.png', types: ["Passive", "Social", "Win Condition"] }, // Passive doesn't have a specific ability icon
        { category: "Modifier", name: "Mini", team: "Global Modifier", desc: "Mini is a Global Modifier which decreases the size of a player.", ability: "Passive Ability", icon: 'Mini', skillIcon: 'Passive.png', types: ["Passive", "Debuff"] }, // Passive doesn't have a specific ability icon
        { category: "Modifier", name: "Radar", team: "Global Modifier", desc: "Radar is a Global Modifier which allows the player to see where the closest player to them currently is. This includes if they are inside a vent.", ability: "Passive Ability", icon: 'Radar', skillIcon: 'Passive.png', types: ["Passive", "Detection"] }, // Passive doesn't have a specific ability icon
        { category: "Modifier", name: "Satellite", team: "Global Modifier", desc: "Satellite is a Global Modifier which allows the player to have a 1 time ability to detect all dead bodies on the map for a short duration.", ability: "Detect Dead Bodies", icon: 'Satellite', skillIcon: 'Satellite.png', types: ["Active", "Detection"] },
        { category: "Modifier", name: "Shy", team: "Global Modifier", desc: "Shy is a Global Modifier which allows the player to become more transparent the longer they stand still.", ability: "Passive Ability", icon: 'Shy', skillIcon: 'Passive.png', types: ["Passive", "Utility"] }, // Passive doesn't have a specific ability icon
        { category: "Modifier", name: "Sixth Sense", team: "Global Modifier", desc: "Sixth Sense is a Global Modifier which allows the player to know when someone interacts with them.", ability: "Passive Ability", icon: 'SixthSense', skillIcon: 'Passive.png', types: ["Passive", "Detection"] }, // Passive doesn't have a specific ability icon
        { category: "Modifier", name: "Sleuth", team: "Global Modifier", desc: "Sleuth is a Global Modifier which allows the player to see the dead player’s roles of who they report during meetings.", ability: "Passive Ability", icon: 'Sleuth', skillIcon: 'Passive.png', types: ["Passive", "Detection"] }, // Passive doesn't have a specific ability icon
        { category: "Modifier", name: "Tiebreaker", team: "Global Modifier", desc: "Tiebreaker is a Global Modifier which gives the player the ability to break a tie during a meeting. In other words, whoever the Tiebreaker votes for has an extra half vote for that meeting.", ability: "Break Tie Vote", icon: 'Tiebreaker', skillIcon: 'Tiebreaker.png', types: ["Active", "Utility"] },

        // Impostor Modifiers
        { category: "Modifier", name: "Disperser", team: "Impostor Modifier", desc: "Disperser is an Impostor Modifier which has a 1 time use ability to send all players to a random vent on the map.", ability: "Disperse Players", icon: 'Disperser', skillIcon: 'TownOfUs.Resources.ImpButtons.DisperseButton.png', types: ["Active", "Sabotage"] },
        { category: "Modifier", name: "Double Shot", team: "Impostor Modifier", desc: "Double Shot is an Impostor Modifier who has an extra life when assassinating. When the Double Shot has their first incorrect guess they will receive a red flash on their screen and be unable to guess who they guessed incorrectly for the remainder of that meeting.", ability: "Passive Ability", icon: 'DoubleShot', skillIcon: 'Passive.png', types: ["Passive", "Kill", "Defense"] }, // Passive doesn't have a specific ability icon
        { category: "Modifier", name: "Saboteur", team: "Impostor Modifier", desc: "Saboteur is an Impostor Modifier which passively decreases non-door sabotage cooldowns.", ability: "Passive Ability", icon: 'Saboteur', skillIcon: 'Passive.png', types: ["Passive", "Sabotage"] }, // Passive doesn't have a specific ability icon
        { category: "Modifier", name: "Underdog", team: "Impostor Modifier", desc: "Underdog is an Impostor Modifier which grants the player a decreased kill cooldown when they are the last Impostor, however, when they have a teammate which is still alive (adjustable by settings), they may have an increased cooldown while that teammate is still alive.", ability: "Passive Ability", icon: 'Underdog', skillIcon: 'Passive.png', types: ["Passive", "Kill", "Buff"] } // Passive doesn't have a specific ability icon
    ];
     ...
     * Assumes role icons are in a 'Role Icons/' subfolder and use the
     * 'TownOfUs.Resources.RoleIcons.{RoleName}.png' naming convention.
     * @param {string} roleName - The name of the role (e.g., "Prosecutor", "Cleric").
    ...
    function getRoleImageUrl(roleName) {
        ...
        // Assuming roleName directly corresponds to the last part of the filename (e.g., "Prosecutor" or "GuardianAngel")
        return `Role Icons/TownOfUs.Resources.RoleIcons.${roleName}.png`;
    }

    /**
     * Returns the path to the modifier icon image based on the modifier name.
     * Assumes modifier icons are in the SAME 'Role Icons/' subfolder as roles,
     * and use the 'TownOfUs.Resources.ModifierIcons.{ModifierName}.png' naming convention.
     * @param {string} modifierName - The name of the modifier (e.g., "Bait").
     * @returns {string} The full image URL.
     */
    function getModifierImageUrl(modifierName) {
        ...
        return `Role Icons/TownOfUs.Resources.ModifierIcons.${modifierName}.png`;
    }

    /**
     * Returns the path to the ability icon image based on its full filename.
     * Assumes ALL ability icons are in a single 'Abilities/' subfolder
     * and the `skillIconFilename` parameter is the complete filename including prefixes.
     * E.g., 'TownOfUs.Resources.ImpButtons.BlackmailButton.png'
     * @param {string} skillIconFilename - The full filename of the skill icon
     * (e.g., "TownOfUs.Resources.ImpButtons.BlackmailButton.png").
     * @returns {string} The full image URL.
     */
    function getAbilityImageUrl(skillIconFilename) {
        if (!skillIconFilename || skillIconFilename.includes('Passive.png') || skillIconFilename.includes('Ghost.png')) {
            // These are generic icons, some of which might not follow the full path convention
            if (skillIconFilename === 'Passive.png') return 'Abilities/Passive.png';
            if (skillIconFilename === 'Ghost.png') return 'Abilities/Ghost.png';
            if (skillIconFilename === 'Charge.png') return 'Abilities/Charge.png';
            if (skillIconFilename === 'Swap.png') return 'Abilities/Swap.png';
            // Specific overrides for icons that are not in the "Buttons" structure but are abilities
            if (skillIconFilename === 'TownOfUs.Resources.ImitatorSelect.png') return 'Abilities/TownOfUs.Resources.ImitatorSelect.png';
            if (skillIconFilename === 'TownOfUs.Resources.MayorButton.png') return 'Abilities/TownOfUs.Resources.MayorButton.png';
            if (skillIconFilename === 'TownOfUs.Resources.RoleIcons.Prosecutor.png') return 'Abilities/TownOfUs.Resources.RoleIcons.Prosecutor.png';
            if (skillIconFilename === 'Satellite.png') return 'Abilities/Satellite.png';
            if (skillIconFilename === 'Tiebreaker.png') return 'Abilities/Tiebreaker.png';
            if (skillIconFilename === 'Sense.png') return 'Abilities/Sense.png';
            if (skillIconFilename === 'Inspect.png') return 'Abilities/Inspect.png';

            // If it's a known generic icon but not one of the specific overrides above, return placeholder.
            return 'placeholder.png';
        }
        // This assumes skillIconFilename is the FULL filename, including any 'TownOfUs.Resources.XButtons.' prefix
        return `Abilities/${skillIconFilename}`;
    }
    ...
    function createCard(entity) {
        ...
        // Determine the correct image URL for the main icon
        ...
        if (descriptionTextElement) {
            descriptionTextElement.style.borderLeftColor = uniqueColor || '#805ad5';
        }
    ...
    function createPlayerEntry(playerName = '', role = '') {
        ...
        const updatePlayerRoleIconAndStyles = () => {
            ...
            let entityForDisplay = null; // This will hold the found entity or constructed generic entity
            let displayRoleName = rawRoleName; // Name to display and for color lookup initially

            // 1. Try to find an exact match in allEntitiesData by the displayed name
            entityForDisplay = allEntitiesData.find(entity =>
                entity.name.toLowerCase() === rawRoleName.toLowerCase()
            );

            if (!entityForDisplay) {
                // 2. If no exact display name match, try matching by icon name (e.g., input "Guardian Angel", icon "GuardianAngel")
                entityForDisplay = allEntitiesData.find(entity =>
                    entity.icon && entity.icon.toLowerCase() === rawRoleName.toLowerCase().replace(/\s/g, '')
                );
                if (entityForDisplay) {
                    displayRoleName = entityForDisplay.name; // Use the official display name for consistency
                }
            }

            // 3. Fallback for generic team names if no specific role/modifier entity is found
            if (!entityForDisplay) {
                const lowerCaseRole = rawRoleName.toLowerCase();
                if (lowerCaseRole === 'impostor') {
                    entityForDisplay = { name: 'Impostor', icon: 'Impostor', category: 'Role', team: 'Impostor' };
                    displayRoleName = 'Impostor';
                } else if (lowerCaseRole === 'crewmate') {
                    entityForDisplay = { name: 'Crewmate', icon: 'Crewmate', category: 'Role', team: 'Crewmate' };
                    displayRoleName = 'Crewmate';
                } else if (lowerCaseRole === 'neutral') {
                    entityForDisplay = { name: 'Neutral', icon: 'Neutral', category: 'Role', team: 'Neutral' };
                    displayRoleName = 'Neutral';
                }
            }


            let newUniqueColor = '#00ffff'; // Default color
            let newIconFilename = 'placeholder.png'; // Default icon path

            if (entityForDisplay) {
                // Determine color based on the found entity's display name
                if (roleColors[displayRoleName]) {
                    newUniqueColor = roleColors[displayRoleName];
                } else if (modifierColors[displayRoleName]) {
                    newUniqueColor = modifierColors[displayRoleName];
                } else {
                    // Fallback to team color for generic entity types
                    const teamBasedColor = teamColors[entityForDisplay.team] || teamColors[entityForDisplay.team.split(' ')[0]];
                    if (teamBasedColor) {
                        newUniqueColor = teamBasedColor.dotColor;
                    }
                }
                ...
                // If no entity found at all, just use raw input for alt text and placeholder icon/default color
                newIconFilename = 'placeholder.png';
                newUniqueColor = '#7e22ce'; // A fallback default color if nothing matches
                displayRoleName = rawRoleName; // Keep the raw name for alt text if no entity found
            }

            // Apply the updated properties to the elements
            roleIconImg.src = newIconFilename;
            roleIconImg.alt = `${displayRoleName || 'Unknown Role'} Icon`; // Display user's input or official name
     ...
     * ability icon, description, and settings.
    ...
    function openModal(entity) {
        ...
        modalDescription.innerHTML = entity.desc; // Use innerHTML to allow for potential HTML in description

        // Set colors based on entity.name for modal
        const uniqueColor = entity.category === 'Role' ? roleColors[entity.name] : modifierColors[entity.name];
        modalName.style.color = uniqueColor || 'red'; // Apply color to name
        const teamKey = entity.team.split(' ')[0];
        const teamStyle = teamColors[teamKey] || teamColors[entity.team] || { dotColor: 'cyan', boxBg: 'rgba(0, 255, 255, 0.2)', boxShadow: '0 0 8px #00ffff' };
        modalTeam.style.backgroundColor = teamStyle.boxBg;
        modalTeam.style.boxShadow = teamStyle.boxShadow;
        modalTeam.style.color = teamStyle.dotColor;
        modalTeam.style.borderColor = teamStyle.dotColor;
        ...
        modalIcon.style.filter = `drop-shadow(0 0 10px ${uniqueColor || 'cyan'})`;
        ...
        modalAbilityIcon.style.filter = `drop-shadow(0 0 6px ${uniqueColor || 'cyan'});`; // Add 'px'
        ...
        if (entity.settings && entity.settings.length > 0) {
            modalSettingsSection.style.display = 'block'; // Show the settings section
            entity.settings.sort((a, b) => a.name.localeCompare(b.name)).forEach(setting => {
                const li = document.createElement('li');
                li.textContent = `${setting.name}: ${setting.value}`;
                modalSettingsList.appendChild(li);
            });
        } else {
            modalSettingsSection.style.display = 'none'; // Hide if no settings
        }
